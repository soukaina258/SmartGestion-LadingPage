...
const SOCIALS = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/smar.tgestion/",
    // Instagram: icon changes to brand gradient text on hover
    iconCls: "hover:border-[#e1306c]/40 hover:bg-[#e1306c]/10 hover:text-[#e1306c]",
    svg: (
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61591082665957",
    iconCls: "hover:border-[#1877F2]/40 hover:bg-[#1877F2]/10 hover:text-[#1877F2]",
    svg: (
      <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor">
  ...
  {
    label: "WhatsApp",
    href: "https://wa.me/212660145157",
    iconCls: "hover:border-[#25D366]/40 hover:bg-[#25D366]/10 hover:text-[#25D366]",
    svg: (
      <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor">
  ...
  {
    label: "TikTok",
    href: "https://www.tiktok.com/@smartgestion1?is_from_webapp=1&sender_device=pc",
    iconCls: "hover:border-black/30 hover:bg-black/8 hover:text-black dark:hover:border-white/30 dark:hover:bg-white/10 dark:hover:text-white",
    svg: (
      <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-10 py-16 sm:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="mt-4 space-y-3">
              {[
                ...
                { label: t.footer.link404,     href: "/not-found" },
              ].map((l) => (
                <li key={l.label}>
                  <Link href={l.href} className="text-sm text-slate-500 transition-colors hover:text-[#1D6FD6] dark:text-white/55 dark:hover:text-white">
                    {l.label}
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="mt-4 space-y-3">
              {SOCIALS.map(({ label, href, iconCls, svg }) => (
