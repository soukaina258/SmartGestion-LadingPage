...
const YtIcon  = () => <svg viewBox="0 0 24 24" className="h-4 w-4" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" /></svg>;

const SOCIALS = [
  { label: "Instagram", href: "https://www.instagram.com/smartgestion.maroc?igsh=aW90eXlhbjFveDM0",                                          iconCls: "hover:border-[#e1306c]/40 hover:bg-[#e1306c]/10 hover:text-[#e1306c]",                                                               Icon: IgIcon },
  ...
  { label: "WhatsApp",  href: "https://wa.me/212620849779",                                                         iconCls: "hover:border-[#25D366]/40 hover:bg-[#25D366]/10 hover:text-[#25D366]",                                                               Icon: WaIcon },
  { label: "YouTube",   href: "https://www.youtube.com/@SmartGestion",                                              iconCls: "hover:border-[#FF0000]/40 hover:bg-[#FF0000]/10 hover:text-[#FF0000]",                                                               Icon: YtIcon },
];
